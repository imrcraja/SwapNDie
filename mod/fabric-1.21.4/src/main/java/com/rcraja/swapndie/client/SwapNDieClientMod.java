 ...
 * under the SAME NamespacedKey the SwapNDie-1.21.4.jar plugin uses
 * (NamespacedKey(plugin, "swapndie_item") -> "swapndie-1.21.4:swapndie_item").
...
public class SwapNDieClientMod implements ClientModInitializer {
    ...
    private static final String PLUGIN_NAMESPACE = "swapndie-1.21.4";
