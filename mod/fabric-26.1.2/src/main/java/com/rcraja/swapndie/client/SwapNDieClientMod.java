 ...
 * under the SAME NamespacedKey the SwapNDie-26.1.2.jar plugin uses
 * (NamespacedKey(plugin, "swapndie_item") -> "swapndie-26.1.2:swapndie_item").
...
public class SwapNDieClientMod implements ClientModInitializer {
    ...
    private static final String PLUGIN_NAMESPACE = "swapndie-26.1.2";
